...
class HouseholdPurchasesSales:
    ...
    def __init__(self, purchase_sales_data):
        ...
        self.category = purchase_sales_data['category']
        self.name = purchase_sales_data['name']
        self.dryseas_pur_price = purchase_sales_data['dryseas_pur_pr']
        self.cost_units = purchase_sales_data['units']
        self.dryseas_pur_quant = purchase_sales_data['dryseas_pur_quant']
        self.quant_units = purchase_sales_data['measure']
        self.wetseas_pur_price = purchase_sales_data['wetseas_pur_pr']
        self.wetseas_pur_quant = purchase_sales_data['wetseas_pur_quant']
        self.dryseas_sale_price = purchase_sales_data['dryseas_sale_pr']
        self.dryseas_sale_quant = purchase_sales_data['dryseas_sale_quant']
        self.wetseas_sale_price = purchase_sales_data['wetseas_sale_pr']
        self.wetseas_sale_quant = purchase_sales_data['wetseas_sale_quant']
...
def test_economics_algorithms(form):
    ...
    # ==============================================================================================
    mgmt_dir = form.settings['mgmt_dir']
